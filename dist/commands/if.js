...
(function (factory) {
    ...
    function Load(scope) {
        var _this = this;
        scope.defineProc('if', function (interpreter, args, command, helpers) { return __awaiter(_this, void 0, void 0, function () {
            var expression, solved, code, newInterpreter, nextop, code_1, newInterpreter;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [3, 1];
                    case 3: return [2, new types_1.TclSimple('')];
                }
            });
        }); }, {
            arguments: {
