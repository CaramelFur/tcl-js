...
let short_monthsregEx = /[Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sept|Oct|Nov|Dec]/;
let short_months = [
  'Jan',
  'Feb',
  'Mar',
...
subcmds = {
  ...
  scan(args, I) {
    ...
    let hasOrdMonth = 0;
    let hasRel = 0;
    let has_meridian = !!meridian_regEx.test(dateString);
    let use_dst = /dst/i.test(dateString);
    let is_isobase = false;
    ...
    function parseDate() {
      ...
      if (pos < dateTokens.length && is_isobase) {
        // TODO: use GetInt()
