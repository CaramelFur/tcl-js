...
class_tests = {
	...
	graph: function (s) {
		return (/[\x00-\x20\x7F-\x9F\xAD]/.exec(s) || {
			index: -1
		}).index;
	},
	...
	print: function (s) {
		return (/[\x00-\x1F\x7F-\x9F\xAD]/.exec(s) || {
			index: -1
		}).index;
	},
	punct: function (s) {
		return (/[^!"#%&'\(\)\*,\-.\/:;\?@\[\\\]_{}\xa1\xa7\xab\xb6\xb7\xbb\xbf]/.exec(s) || {
			index: -1
		}).index;
	},
	space: function (s) {
